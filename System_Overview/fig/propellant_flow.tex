...
\node[font=\tiny, text=KJOgray, below=1pt of oxv]
  {also serves DUMP (vents through chamber)};
...
\node[font=\tiny, anchor=west, align=left, text=KJOgray] at (11.15, -6.65) {Chamber\\Pressure};
